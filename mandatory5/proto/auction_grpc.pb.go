...
func (c *auctionClient) Result(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Outcome, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Outcome)
...
func (UnimplementedAuctionServer) Result(context.Context, *emptypb.Empty) (*Outcome, error) {
